...
public class NewCustomProcessDiagramGenerator extends DefaultProcessDiagramGenerator {

    //预初始化流程图绘制，大大提升了系统启动后首次查看流程图的速度
    static {
        new NewCustomProcessDiagramCanvas(10, 10, 0, 0, "png", "宋体", "微软雅黑", "黑体", null);
    }

    protected static NewCustomProcessDiagramCanvas initProcessDiagramCanvas(BpmnModel bpmnModel, String imageType,
        ...
        return new NewCustomProcessDiagramCanvas((int) maxX + 10, (int) maxY + 10, (int) minX, (int) minY,
                imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    }

    public NewCustomProcessDiagramCanvas generateProcessDiagram(BpmnModel bpmnModel, String imageType,
        ...
        NewCustomProcessDiagramCanvas processDiagramCanvas = initProcessDiagramCanvas(bpmnModel, imageType, activityFontName, labelFontName, annotationFontName, customClassLoader);
    ...
    protected void drawActivity(NewCustomProcessDiagramCanvas processDiagramCanvas, BpmnModel bpmnModel, FlowNode flowNode,
    ...
    protected void drawHighLight(boolean isStartOrEnd, NewCustomProcessDiagramCanvas processDiagramCanvas, GraphicInfo graphicInfo, Color color) {
    ...
    public InputStream generateDiagram(BpmnModel bpmnModel, String imageType, List<String> highLightedActivities,
        ...
        NewCustomProcessDiagramCanvas customProcessDiagramCanvas = generateProcessDiagram(bpmnModel, imageType, highLightedActivities, highLightedFlows,
